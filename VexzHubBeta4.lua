...
-- =====================================================
-- AUTO STATS (THÊM MỚI - TỰ ĐỘNG NÂNG ĐIỂM CHỈ SỐ)
-- =====================================================
local AutoStatsEnabled = false
local SelectedStat = "Melee" -- Melee, Defense, Sword, Gun, Blox Fruit
...
-- =====================================================
-- MAIN FARM LOOP (FIX: Auto equip weapon khi farm)
-- =====================================================
task.spawn(function()
    while true do
        task.wait(0.2)
        ...
        -- FIX: Tự động trang bị vũ khí khi bắt đầu farm
        equipWeapon()
...
local Tabs = {
    ...
    LocalPlayer = Window:AddTab({ Title = "LocalPlayer", Icon = "user" }), -- THÊM MỚI
    Misc   = Window:AddTab({ Title = "Misc",   Icon = "settings" }),
}

-- =====================================================
-- TAB FARM (THÊM: Select Weapon)
-- =====================================================
...
Tabs.Farm:AddSection("Select Weapon")
Tabs.Farm:AddDropdown("SelectWeapon", {
    Title = "Select Weapon",
    Description = "Auto equip when farming",
    Values = {"Melee", "Sword", "Blox Fruit"},
    Default = "Melee",
    Multi = false,
}):OnChanged(function(v) SelectedWeapon = v end)
...
-- =====================================================
-- TAB LOCALPLAYER (THÊM MỚI - AUTO STATS)
-- =====================================================
Tabs.LocalPlayer:AddSection("Auto Stats")
Tabs.LocalPlayer:AddParagraph({
    Title = "Thông tin",
    Content = "Tự động nâng điểm chỉ số theo lựa chọn"
})

Tabs.LocalPlayer:AddToggle("AutoStats", {
    Title       = "Auto Stats",
    Description = "Bật/Tắt tự động nâng điểm",
    Default     = false,
}):OnChanged(function(v) 
    AutoStatsEnabled = v 
    if v then
        print("[Vexz Hub] Auto Stats: ON - Selected: " .. SelectedStat)
    else
        print("[Vexz Hub] Auto Stats: OFF")
    end
end)

Tabs.LocalPlayer:AddDropdown("SelectStat", {
    Title = "Chọn chỉ số cần nâng",
    Description = "Chọn loại chỉ số muốn tăng",
    Values = {"Melee", "Defense", "Sword", "Gun", "Blox Fruit"},
    Default = "Melee",
    Multi = false,
}):OnChanged(function(v) 
    SelectedStat = v 
    print("[Vexz Hub] Selected Stat: " .. v)
end)

Tabs.LocalPlayer:AddSection("Thông tin chỉ số")
Tabs.LocalPlayer:AddParagraph({
    Title = "Hướng dẫn",
    Content = "Melee: Tăng sát thương đánh tay\nDefense: Tăng máu\nSword: Tăng sát thương kiếm\nGun: Tăng sát thương súng\nBlox Fruit: Tăng sát thương trái ác quỷ"
})
...
print("[Vexz Hub] Loaded! Anti AFK: ON | Auto Buso: ON | Select Weapon: Ready | Fast Attack: ON (0.05s) | Auto Quest: Ready | Bring Mob: Ready | Auto Stats: Ready | Floating Button: Added")
